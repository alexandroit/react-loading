# @revivejs/react-loading

> A maintained React wrapper for **@revivejs/loading** with declarative components, container overlays, a fullscreen-ready hook, and versioned demos for React 17, 18, and 19.

[![npm version](https://img.shields.io/npm/v/@revivejs/react-loading.svg?style=flat-square)](https://www.npmjs.com/package/@revivejs/react-loading)
[![npm downloads](https://img.shields.io/npm/dt/@revivejs/react-loading.svg?style=flat-square)](https://www.npmjs.com/package/@revivejs/react-loading)
[![npm monthly](https://img.shields.io/npm/dm/@revivejs/react-loading.svg?style=flat-square)](https://www.npmjs.com/package/@revivejs/react-loading)
[![license](https://img.shields.io/npm/l/@revivejs/react-loading.svg?style=flat-square)](https://github.com/alexandroit/react-loading/blob/main/LICENSE)
...
**[Documentation & Live Demos](https://alexandroit.github.io/react-loading/)** | **[npm](https://www.npmjs.com/package/@revivejs/react-loading)** | **[Issues](https://github.com/alexandroit/react-loading/issues)** | **[Repository](https://github.com/alexandroit/react-loading)**
...
`@revivejs/react-loading` keeps the full ReviveJS loading engine intact while adapting it to modern React applications.
...
| Package version | React version | Demo link |
| :---: | :---: | :--- |
| **19.0.0** | **19.2.x** | [React 19 demo](https://alexandroit.github.io/react-loading/react-19/) |
| **18.0.0** | **18.3.x** | [React 18 demo](https://alexandroit.github.io/react-loading/react-18/) |
| **17.0.0** | **17.0.x** | [React 17 demo](https://alexandroit.github.io/react-loading/react-17/) |

## Installation

```bash
npm install @revivejs/react-loading
```
