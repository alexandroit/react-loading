...
`,T=`.rvl-variant--`,fe=new Map;function pe(e){let t=`${T}${e}`,n=[],r=0;for(;r<w.length;){for(;r<w.length&&/\s/.test(w[r]??``);)r+=1;if(r>=w.length)break;let e=r;for(;r<w.length&&w[r]!==`{`;)r+=1;if(r>=w.length)break;let i=w.slice(e,r).trim();r+=1;let a=r,o=1;for(;r<w.length&&o>0;){let e=w[r];e===`{`?o+=1:e===`}`&&--o,r+=1}if(!i.includes(T))continue;let s=i.split(`,`).map(e=>e.trim()).filter(Boolean).filter(e=>e.includes(t));if(!s.length)continue;let c=w.slice(a,r-1).trimEnd();n.push(`${s.join(`,
`)} {
${c}
}`)}return n.join(`

`)}function me(e){let t=fe.get(e);if(t)return t;let n=pe(e);return fe.set(e,n),n}function he(e){return e?`${de}
${me(e)}`:`${de}
${w}`}var E=de;he();function D(){return typeof window<`u`&&typeof document<`u`}var ge=`data-rvl-loading-base`,_e=`data-rvl-loading-variant`;function ve(e){if(e.head.querySelector(`[${ge}]`))return;let t=e.createElement(`style`);t.setAttribute(ge,`true`),t.textContent=E,e.head.append(t)}function ye(e,t){if(t.head.querySelector(`[${_e}="${e}"]`))return;let n=me(e);if(!n.trim())return;let r=t.createElement(`style`);r.setAttribute(_e,e),r.textContent=n,t.head.append(r)}function be(e,t=document){D()&&(ve(t),ye(e,t))}function xe(e,t=document){if(typeof e==`string`){let n=t.querySelector(e);if(!n)throw Error(`@revivejs/loading could not find target "${e}".`);return n}return e instanceof HTMLElement?e:t.body}function Se(e){if(e===document.body||e===document.documentElement)return()=>void 0;let t=window.getComputedStyle(e).position;if(t&&t!==`static`)return()=>void 0;let n=e.style.position;return e.style.position=`relative`,()=>{if(n){e.style.position=n;return}e.style.removeProperty(`position`)}}var Ce=0;function we(e=`rvl`){return Ce+=1,`${e}-${Ce}`}var Te=class{constructor(e={}){if(y(this,`id`,we()),y(this,`element`),y(this,`state`,{mounted:!1,visible:!1,destroyed:!1,pending:null}),y(this,`bodyElement`),y(this,`visualElement`),y(this,`labelElement`),y(this,`srElement`),y(this,`options`),y(this,`mountedTarget`,null),y(this,`restorePositionContext`,null),y(this,`showTimeoutId`,null),y(this,`hideTimeoutId`,null),y(this,`showResolver`,null),y(this,`hideResolver`,null),y(this,`shownAt`,0),!D())throw Error(`@revivejs/loading requires a browser-like DOM to create loaders.`);this.options=ue(e),be(this.options.variant),this.element=document.createElement(`div`),this.element.dataset.rvlLoader=this.id,this.bodyElement=document.createElement(`div`),this.bodyElement.className=`rvl-body`,this.visualElement=document.createElement(`div`),this.visualElement.className=`rvl-visual`,this.visualElement.setAttribute(`aria-hidden`,`true`),this.labelElement=document.createElement(`span`),this.labelElement.className=`rvl-label`,this.srElement=document.createElement(`span`),this.srElement.className=`rvl-sr-only`,this.bodyElement.append(this.visualElement,this.labelElement,this.srElement),this.element.append(this.bodyElement),this.render(),(this.options.target||this.options.fullscreen)&&this.mount(this.options.target),this.options.visible?this.show():this.element.hidden=!0}getOptions(){return{...this.options,style:{...this.options.style}}}mount(e){this.assertAlive();let t=this.resolveMountTarget(e);return this.mountedTarget===t&&this.state.mounted?this:(this.unmount(),this.options.overlay&&!this.options.fullscreen&&(this.restorePositionContext=Se(t)),t.append(this.element),this.mountedTarget=t,this.state.mounted=!0,this)}unmount(){return this.element.parentElement&&this.element.parentElement.removeChild(this.element),this.restorePositionContext&&=(this.restorePositionContext(),null),this.mountedTarget=null,this.state.mounted=!1,this}show(){return this.assertAlive(),this.state.visible&&this.state.pending!==`hide`?Promise.resolve():(this.clearHideTimer(!0),this.state.pending=`show`,this.state.mounted||this.mount(this.options.target),new Promise(e=>{let t=()=>{this.state.pending=null,this.state.visible=!0,this.shownAt=Date.now(),this.element.hidden=!1,this.syncVisibility(),this.showResolver?.(),this.showResolver=null};if(this.clearShowTimer(!0),this.showResolver=e,this.options.delay>0){this.showTimeoutId=window.setTimeout(t,this.options.delay);return}t()}))}hide(){return this.assertAlive(),!this.state.visible&&this.state.pending!==`show`?(this.syncVisibility(),Promise.resolve()):(this.clearShowTimer(!0),this.state.pending=`hide`,new Promise(e=>{let t=()=>{this.state.pending=null,this.state.visible=!1,this.syncVisibility(),this.hideResolver?.(),this.hideResolver=null};if(this.clearHideTimer(!0),this.hideResolver=e,!this.state.visible){t();return}let n=this.shownAt?Date.now()-this.shownAt:0,r=Math.max(0,this.options.minVisible-n);if(r>0){this.hideTimeoutId=window.setTimeout(t,r);return}t()}))}toggle(e){return(typeof e==`boolean`?e:!this.state.visible)?this.show():this.hide()}update(e){this.assertAlive();let t=this.resolveMountTarget();this.options=ue({...this.options,...e,style:{...this.options.style,...e.style??{}}}),be(this.options.variant),this.render();let n=this.resolveMountTarget();return t!==n&&this.state.mounted&&this.mount(n),this}destroy(){this.state.destroyed||(this.clearShowTimer(!0),this.clearHideTimer(!0),this.unmount(),this.state.destroyed=!0)}render(){let e=S(this.options.variant);this.element.className=[`rvl-loader`,`rvl-variant--${this.options.variant}`,this.options.inline?`is-inline`:`is-block`,this.options.overlay?`is-overlay`:``,this.options.fullscreen?`is-fullscreen`:``,this.options.centered?`is-centered`:``,this.options.label?`has-label`:``,this.options.className].filter(Boolean).join(` `),this.element.setAttribute(`role`,`status`),this.element.setAttribute(`aria-live`,this.options.ariaLive),this.element.setAttribute(`aria-atomic`,`true`),this.element.setAttribute(`aria-busy`,this.state.visible?`true`:`false`),this.element.dataset.variant=this.options.variant,this.element.style.cssText=``,this.element.style.setProperty(`--rvl-size`,this.options.size),this.element.style.setProperty(`--rvl-color`,this.options.color),this.element.style.setProperty(`--rvl-secondary-color`,this.options.secondaryColor),this.element.style.setProperty(`--rvl-speed`,`${this.options.speed}ms`),this.element.style.setProperty(`--rvl-thickness`,`${this.options.thickness}px`),this.element.style.setProperty(`--rvl-opacity`,`${this.options.opacity}`),this.element.style.setProperty(`--rvl-background`,this.options.background),this.element.style.setProperty(`--rvl-blur`,`${this.options.blur}px`),this.element.style.setProperty(`--rvl-radius`,this.options.radius),this.element.style.setProperty(`--rvl-gap`,`${this.options.gap}px`),this.element.style.setProperty(`--rvl-z-index`,`${this.options.zIndex}`),this.element.style.setProperty(`animation-direction`,this.options.direction),ae(this.element,this.options.style),this.labelElement.textContent=this.options.label,this.srElement.textContent=this.options.label,this.options.label?this.element.setAttribute(`aria-label`,this.options.label):this.element.removeAttribute(`aria-label`),this.element.title=e.label,this.visualElement.replaceChildren();for(let e=0;e<this.options.count;e+=1){let t=document.createElement(`span`);t.className=`rvl-part`,t.style.setProperty(`--part-index`,String(e)),this.visualElement.append(t)}this.syncVisibility()}syncVisibility(){this.element.hidden=!this.state.visible,this.element.setAttribute(`aria-busy`,this.state.visible?`true`:`false`),this.element.setAttribute(`aria-hidden`,this.state.visible?`false`:`true`)}resolveMountTarget(e){return this.options.fullscreen?document.body:xe(e??this.options.target)}clearShowTimer(e=!1){this.showTimeoutId!=null&&(window.clearTimeout(this.showTimeoutId),this.showTimeoutId=null),e&&this.showResolver&&(this.showResolver(),this.showResolver=null)}clearHideTimer(e=!1){this.hideTimeoutId!=null&&(window.clearTimeout(this.hideTimeoutId),this.hideTimeoutId=null),e&&this.hideResolver&&(this.hideResolver(),this.hideResolver=null)}assertAlive(){if(this.state.destroyed)throw Error(`@revivejs/loading cannot operate on a destroyed loader.`)}};function Ee(e={}){return new Te(e)}var O=c(u(),1),De=typeof window<`u`?O.useLayoutEffect:O.useEffect,Oe=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),k=o(((e,t)=>{t.exports=Oe()}))();function ke(e,t,n){return e.current?n.current?(n.current.update({...t,target:e.current}),n.current):(n.current=Ee({...t,target:e.current,visible:!1}),n.current):null}var Ae=(0,O.forwardRef)(function({options:e={},visible:t=!0,onCreate:n,onShown:r,onHidden:i,onUpdated:a,onDestroyed:o,...s},c){let l=(0,O.useRef)(null),u=(0,O.useRef)(null);return(0,O.useImperativeHandle)(c,()=>({getInstance(){return u.current},show(){return u.current?u.current.show():Promise.resolve()},hide(){return u.current?u.current.hide():Promise.resolve()},toggle(e){return u.current?u.current.toggle(e):Promise.resolve()},update(e){u.current&&u.current.update(e)},destroy(){if(u.current){let e=u.current;e.destroy(),u.current=null,o?.(e)}}}),[o]),De(()=>{let t=ke(l,e,u);if(t)return n?.(t),()=>{if(u.current){let e=u.current;e.destroy(),u.current=null,o?.(e)}}},[]),(0,O.useEffect)(()=>{let n=ke(l,e,u);if(n){if(a?.(n),t){n.show().then(()=>{r?.(n)});return}n.hide().then(()=>{i?.(n)})}},[e,t,i,r,a]),(0,k.jsx)(`div`,{ref:l,...s})});function je(e,t,n){if(!e.current)return null;let r={overlay:!0,centered:!0,...t,target:e.current};return n.current?(n.current.update(r),n.current):(n.current=Ee({...r,visible:!1}),n.current)}var Me=(0,O.forwardRef)(function({children:e,options:t={},visible:n=!0,onCreate:r,onShown:i,onHidden:a,onUpdated:o,onDestroyed:s,style:c,...l},u){let d=(0,O.useRef)(null),f=(0,O.useRef)(null);return(0,O.useImperativeHandle)(u,()=>({getInstance(){return f.current},show(){return f.current?f.current.show():Promise.resolve()},hide(){return f.current?f.current.hide():Promise.resolve()},toggle(e){return f.current?f.current.toggle(e):Promise.resolve()},update(e){f.current&&f.current.update(e)},destroy(){if(f.current){let e=f.current;e.destroy(),f.current=null,s?.(e)}}}),[s]),De(()=>{let e=je(d,t,f);if(e)return r?.(e),()=>{if(f.current){let e=f.current;e.destroy(),f.current=null,s?.(e)}}},[]),(0,O.useEffect)(()=>{let e=je(d,t,f);if(e){if(o?.(e),n){e.show().then(()=>{i?.(e)});return}e.hide().then(()=>{a?.(e)})}},[t,n,a,i,o]),(0,k.jsx)(`div`,{ref:d,style:{position:`relative`,...c},...l,children:e})});function Ne(e,t,n){let r={...e,...n||{}};return t!==void 0&&(r.target=t),r}function Pe(e={}){let t=(0,O.useRef)(null),n=(0,O.useRef)(e);n.current=e,(0,O.useEffect)(()=>()=>{t.current&&=(t.current.destroy(),null)},[]);function r(e,r){let i=Ne(n.current,e,r);return t.current?(i.target!==void 0&&t.current.mount(i.target),t.current.update(i),t.current):(t.current=Ee({...i,visible:!1}),t.current)}return{create(e,t){return r(e,t)},mount(e,t){return r(e,t)},async show(e,t){let n=r(e,t);return await n.show(),n},hide(){return t.current?t.current.hide():Promise.resolve()},toggle(e){return t.current?t.current.toggle(e):Promise.resolve()},update(e){return t.current?(t.current.update(e),t.current):null},destroy(){t.current&&=(t.current.destroy(),null)},getInstance(){return t.current}}}var Fe=g(),Ie=(te||[]).map(e=>({value:e.value,label:e.label})),Le=[{id:`default`,label:`Default`,description:`A clean centered stage for checking size, color, speed, and label choices.`},{id:`dashboard`,label:`Dashboard`,description:`Keep product cards visible while the active region stays anchored to a loading state.`},{id:`table`,label:`Table`,description:`A common analytics refresh pattern where the user should keep their table context.`},{id:`page`,label:`Page`,description:`Simulate a route-level or workspace-level loading state inside the docs shell.`},{id:`modal`,label:`Modal`,description:`Load only the modal body while keeping the dialog frame stable.`},{id:`chart`,label:`Chart`,description:`Useful for analytical surfaces where movement should feel intentional and data-centric.`},{id:`upload`,label:`Upload`,description:`A drop zone preview for uploads, media workflows, and file-heavy forms.`}],Re={variant:`orbit`,size:60,speed:900,color:`#2563eb`,secondaryColor:`#c7d2fe`,overlay:!1,fullscreen:!1,centered:!0,label:`Loading preview`,delay:0,minVisible:240,reducedMotion:!1};function ze(e,t){let n=``;for(let r=0;r<t;r+=1)n+=e;return n}function Be(e){return String(e).split(`'`).join(`\\'`)}function Ve(e){let t=e.fullscreen,n=e.overlay||t,r={variant:e.variant,size:e.size,speed:e.speed,color:e.color,secondaryColor:e.secondaryColor,centered:n?!0:e.centered,delay:e.delay,minVisible:e.minVisible};return e.label&&(r.label=e.label),n&&(r.overlay=!0),t&&(r.background=`rgba(15, 23, 42, 0.54)`),r}function He(e,t,n=!1){let r=ze(` `,t),i=ze(` `,t+2),a=[`{`,`${i}variant: '${e.variant}',`,`${i}size: ${e.size},`,`${i}speed: ${e.speed},`,`${i}color: '${e.color}',`,`${i}secondaryColor: '${e.secondaryColor}',`];return(e.overlay||e.fullscreen||n)&&a.push(`${i}overlay: true,`),e.fullscreen&&(a.push(`${i}fullscreen: true,`),a.push(`${i}background: 'rgba(15, 23, 42, 0.54)',`)),e.centered&&!e.fullscreen&&a.push(`${i}centered: true,`),e.label&&a.push(`${i}label: '${Be(e.label)}',`),e.delay>0&&a.push(`${i}delay: ${e.delay},`),e.minVisible!==240&&a.push(`${i}minVisible: ${e.minVisible},`),a.push(`${r}}`),a.join(`
`)}function Ue(e){return e===`modal`?[`<div className="modal-shell">`,`  <div className="modal-header" />`,`  <div className="modal-body">`,`    <div className="modal-line" />`,`    <div className="modal-line short" />`,`    <div className="modal-line" />`,`  </div>`,`</div>`].join(`
...
`)}function We(e,t){return e.fullscreen?[`import { useLoadingController } from '@revivejs/react-loading';`,``,`export function WorkspaceAction() {`,`  const loading = useLoadingController();`,``,`  async function showLoader() {`,`    const instance = await loading.show(document.body, ${He(e,6,!0)});`,`    window.setTimeout(() => {`,`      void instance.hide();`,`    }, 1200);`,`  }`,``,`  return <button onClick={showLoader}>Show fullscreen loader</button>;`,`}`].join(`
`):t===`default`&&!e.overlay?[`import { Loading } from '@revivejs/react-loading';`,``,`export function LoadingPreview() {`,`  return (`,`    <Loading`,`      visible={isLoading}`,`      options=${He(e,6)}`,`      style={{ minHeight: 220 }}`,`    />`,`  );`,`}`].join(`
`):[`import { LoadingOverlay } from '@revivejs/react-loading';`,``,`export function LoadingSurface() {`,`  return (`,`    <LoadingOverlay`,`      visible={isLoading}`,`      options=${He(e,6,!0)}`,`    >`,Ue(t).split(`
`).map(e=>`      ${e}`).join(`
`),`    </LoadingOverlay>`,`  );`,`}`].join(`
`)}function Ge({fullscreen:e,options:t,surface:n,visible:r}){return n===`default`&&!t.overlay?(0,k.jsx)(`div`,{className:`playground-surface playground-surface--clean ${e?`is-fullscreen-simulated`:``}`,children:(0,k.jsx)(Ae,{visible:r,options:t,className:`playground-loader-host`,style:{minHeight:e?400:320,width:`100%`}})}):n===`table`?(0,k.jsxs)(Me,{visible:r,options:t,className:`playground-surface surface-table ${e?`is-fullscreen-simulated`:``}`,children:[(0,k.jsxs)(`div`,{className:`playground-table-head`,children:[(0,k.jsx)(`span`,{children:`Status`}),(0,k.jsx)(`span`,{children:`Customer`}),(0,k.jsx)(`span`,{children:`Plan`}),(0,k.jsx)(`span`,{children:`MRR`})]}),Array.from({length:4},(e,t)=>(0,k.jsxs)(`div`,{className:`playground-table-row`,children:[(0,k.jsx)(`span`,{children:(0,k.jsx)(`i`,{})}),(0,k.jsx)(`span`,{children:(0,k.jsx)(`i`,{})}),(0,k.jsx)(`span`,{children:(0,k.jsx)(`i`,{})}),(0,k.jsx)(`span`,{children:(0,k.jsx)(`i`,{})})]},`row-${t}`))]}):n===`page`?(0,k.jsxs)(Me,{visible:r,options:t,className:`playground-surface surface-page ${e?`is-fullscreen-simulated`:``}`,children:[(0,k.jsx)(`div`,{className:`page-topbar`}),(0,k.jsxs)(`div`,{className:`page-grid`,children:[(0,k.jsx)(`div`,{className:`page-tile`}),(0,k.jsx)(`div`,{className:`page-tile`}),(0,k.jsx)(`div`,{className:`page-tile`}),(0,k.jsx)(`div`,{className:`page-tile`})]})]}):n===`modal`?(0,k.jsx)(`div`,{className:`playground-surface surface-modal ${e?`is-fullscreen-simulated`:``}`,children:(0,k.jsxs)(`div`,{className:`modal-shell`,children:[(0,k.jsx)(`div`,{className:`modal-header`}),(0,k.jsxs)(Me,{visible:r,options:t,className:`modal-body`,children:[(0,k.jsx)(`div`,{className:`modal-line`}),(0,k.jsx)(`div`,{className:`modal-line short`}),(0,k.jsx)(`div`,{className:`modal-line`})]})]})}):n===`chart`?(0,k.jsxs)(Me,{visible:r,options:t,className:`playground-surface surface-chart ${e?`is-fullscreen-simulated`:``}`,children:[(0,k.jsx)(`div`,{className:`chart-bar`,style:{height:`28%`}}),(0,k.jsx)(`div`,{className:`chart-bar`,style:{height:`46%`}}),(0,k.jsx)(`div`,{className:`chart-bar`,style:{height:`60%`}}),(0,k.jsx)(`div`,{className:`chart-bar`,style:{height:`38%`}}),(0,k.jsx)(`div`,{className:`chart-bar`,style:{height:`72%`}}),(0,k.jsx)(`div`,{className:`chart-bar`,style:{height:`55%`}})]}):n===`upload`?(0,k.jsxs)(Me,{visible:r,options:t,className:`playground-surface surface-upload ${e?`is-fullscreen-simulated`:``}`,children:[(0,k.jsx)(`div`,{className:`upload-icon`}),(0,k.jsx)(`div`,{className:`upload-title`,children:`Drop files here`}),(0,k.jsx)(`div`,{className:`upload-caption`,children:`PNG, SVG, PDF up to 25 MB`})]}):(0,k.jsxs)(Me,{visible:r,options:t,className:`playground-surface surface-card-grid ${e?`is-fullscreen-simulated`:``}`,children:[(0,k.jsx)(`div`,{className:`surface-card-cell`}),(0,k.jsx)(`div`,{className:`surface-card-cell`}),(0,k.jsx)(`div`,{className:`surface-card-cell wide`})]})}function Ke(){let[e,t]=(0,O.useState)(Re),[n,r]=(0,O.useState)(`default`),[i,a]=(0,O.useState)(`Copy code`),[o,s]=(0,O.useState)(!0),c=Ve(e),l=We(e,n);function u(e,n){t(t=>({...t,[e]:n}))}function d(){s(!1),window.setTimeout(()=>{s(!0)},40)}async function f(){try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(l);else{let e=document.createElement(`textarea`);e.value=l,e.setAttribute(`readonly`,`true`),e.style.position=`absolute`,e.style.left=`-9999px`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e)}a(`Copied`)}catch{a(`Copy failed`)}window.setTimeout(()=>{a(`Copy code`)},1200)}let p=Le.find(e=>e.id===n)?.description||``;return(0,k.jsxs)(`section`,{className:`demo-card playground-card`,id:`playground`,children:[(0,k.jsx)(`div`,{className:`demo-head`,children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{children:`Playground`}),(0,k.jsx)(`p`,{children:`Use the React wrapper against the same kind of interactive preview shell as the core docs.`})]})}),(0,k.jsxs)(`div`,{className:`playground-shell`,children:[(0,k.jsxs)(`form`,{className:`playground-controls`,children:[(0,k.jsxs)(`div`,{className:`field`,children:[(0,k.jsx)(`label`,{htmlFor:`playground-variant`,children:`Variant`}),(0,k.jsx)(`select`,{id:`playground-variant`,value:e.variant,onChange:e=>u(`variant`,e.target.value),children:Ie.map(e=>(0,k.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,k.jsxs)(`div`,{className:`field`,children:[(0,k.jsxs)(`label`,{htmlFor:`playground-size`,children:[`Size `,(0,k.jsxs)(`span`,{children:[e.size,`px`]})]}),(0,k.jsx)(`input`,{id:`playground-size`,type:`range`,min:`18`,max:`96`,value:e.size,onChange:e=>u(`size`,Number(e.target.value))})]}),(0,k.jsxs)(`div`,{className:`field`,children:[(0,k.jsxs)(`label`,{htmlFor:`playground-speed`,children:[`Speed `,(0,k.jsxs)(`span`,{children:[e.speed,`ms`]})]}),(0,k.jsx)(`input`,{id:`playground-speed`,type:`range`,min:`300`,max:`2200`,step:`50`,value:e.speed,onChange:e=>u(`speed`,Number(e.target.value))})]}),(0,k.jsxs)(`div`,{className:`field two-up`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{htmlFor:`playground-color`,children:`Primary`}),(0,k.jsx)(`input`,{id:`playground-color`,type:`color`,value:e.color,onChange:e=>u(`color`,e.target.value)})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{htmlFor:`playground-secondary-color`,children:`Secondary`}),(0,k.jsx)(`input`,{id:`playground-secondary-color`,type:`color`,value:e.secondaryColor,onChange:e=>u(`secondaryColor`,e.target.value)})]})]}),(0,k.jsxs)(`div`,{className:`field`,children:[(0,k.jsx)(`label`,{htmlFor:`playground-label`,children:`Label`}),(0,k.jsx)(`input`,{id:`playground-label`,type:`text`,value:e.label,onChange:e=>u(`label`,e.target.value)})]}),(0,k.jsxs)(`div`,{className:`field two-up`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{htmlFor:`playground-delay`,children:`Delay`}),(0,k.jsx)(`input`,{id:`playground-delay`,type:`number`,min:`0`,step:`50`,value:e.delay,onChange:e=>u(`delay`,Number(e.target.value))})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{htmlFor:`playground-min-visible`,children:`Min visible`}),(0,k.jsx)(`input`,{id:`playground-min-visible`,type:`number`,min:`0`,step:`50`,value:e.minVisible,onChange:e=>u(`minVisible`,Number(e.target.value))})]})]}),(0,k.jsxs)(`div`,{className:`toggle-row`,children:[(0,k.jsxs)(`label`,{children:[(0,k.jsx)(`input`,{type:`checkbox`,checked:e.overlay,onChange:e=>u(`overlay`,e.target.checked)}),` Overlay`]}),(0,k.jsxs)(`label`,{children:[(0,k.jsx)(`input`,{type:`checkbox`,checked:e.fullscreen,onChange:e=>u(`fullscreen`,e.target.checked)}),` Fullscreen`]}),(0,k.jsxs)(`label`,{children:[(0,k.jsx)(`input`,{type:`checkbox`,checked:e.centered,onChange:e=>u(`centered`,e.target.checked)}),` Centered`]}),(0,k.jsxs)(`label`,{children:[(0,k.jsx)(`input`,{type:`checkbox`,checked:e.reducedMotion,onChange:e=>u(`reducedMotion`,e.target.checked)}),` Reduced motion`]})]}),(0,k.jsxs)(`div`,{className:`playground-actions`,children:[(0,k.jsx)(`button`,{type:`button`,onClick:d,children:`Replay timing`}),(0,k.jsx)(`button`,{type:`button`,className:`ghost-button`,onClick:f,children:i})]})]}),(0,k.jsxs)(`div`,{className:`playground-preview`,children:[(0,k.jsx)(`div`,{className:`playground-preview-tabs`,role:`tablist`,"aria-label":`Preview surfaces`,children:Le.map(e=>(0,k.jsx)(`button`,{type:`button`,role:`tab`,className:`playground-preview-tab ${n===e.id?`is-active`:``}`,"aria-selected":n===e.id,onClick:()=>r(e.id),children:e.label},e.id))}),(0,k.jsx)(`p`,{className:`playground-description`,children:p}),(0,k.jsx)(`div`,{className:`playground-stage ${e.reducedMotion?`is-reduced-motion`:``}`,children:(0,k.jsx)(Ge,{fullscreen:e.fullscreen,options:c,surface:n,visible:o})}),(0,k.jsx)(`pre`,{className:`code-block code-preview`,children:l})]})]})]})}var qe=`npm install @revivejs/react-loading`,Je=`import { Loading } from '@revivejs/react-loading';
...
}`,Ye=`import { LoadingOverlay } from '@revivejs/react-loading';
...
}`,Xe=`import { useLoadingController } from '@revivejs/react-loading';
...
}`;function Ze(e){return`${new Date().toLocaleTimeString(`en-US`,{hour12:!1})}  ${e}`}function Qe({title:e,description:t,code:n,children:r}){return(0,k.jsxs)(`section`,{className:`demo-card`,children:[(0,k.jsx)(`div`,{className:`demo-head`,children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{children:e}),(0,k.jsx)(`p`,{children:t})]})}),n?(0,k.jsx)(`pre`,{className:`code-block`,children:n}):null,r]})}function $e({reactLine:e}){let t=Pe(),[n,r]=(0,O.useState)([Ze(`React ${e} docs ready.`)]),[i,a]=(0,O.useState)(!0),[o,s]=(0,O.useState)(!1);function c(e){r(t=>[Ze(e),...t].slice(0,16))}async function l(){c(`Showing fullscreen loader from useLoadingController.`);let e=await t.show(document.body,{fullscreen:!0,overlay:!0,centered:!0,variant:`galaxy`,color:`#38bdf8`,secondaryColor:`#bfdbfe`,minVisible:500,label:`Loading workspace`});window.setTimeout(()=>{e.hide().then(()=>{c(`Fullscreen loader hidden.`)})},1300)}function u(){a(!1),window.setTimeout(()=>{a(!0),c(`Dashboard overlay replayed.`)},40)}function d(){s(!0),c(`Button loading state activated.`),window.setTimeout(()=>{s(!1),c(`Button loading state cleared.`)},1200)}return(0,k.jsxs)(`div`,{className:`app-shell`,children:[(0,k.jsxs)(`header`,{className:`hero-grid`,children:[(0,k.jsxs)(`section`,{className:`hero-card hero-main`,children:[(0,k.jsxs)(`span`,{className:`badge`,children:[`React `,e,` · Loading wrapper`]}),(0,k.jsx)(`h1`,{children:`@revivejs/react-loading`}),(0,k.jsx)(`p`,{children:`Maintained React bindings for the ReviveJS loading toolkit. Keep the loading engine framework-agnostic, then add React-native ergonomics for declarative components, container overlays, and fullscreen programmatic states.`}),(0,k.jsxs)(`div`,{className:`hero-actions`,children:[(0,k.jsx)(`a`,{className:`button primary`,href:`#playground`,children:`Open playground`}),(0,k.jsx)(`a`,{className:`button secondary`,href:`https://github.com/alexandroit/react-loading#readme`,rel:`noreferrer`,target:`_blank`,children:`README`})]}),(0,k.jsxs)(`div`,{className:`hero-notes`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`Declarative`}),` Use a plain React component when the loader itself is what you want to render.`]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`Overlay-ready`}),` Wrap a card, table, modal body, chart shell, or upload zone without rewriting the surface.`]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`Programmatic`}),` Use a hook for fullscreen or route-level loading where document-level control is useful.`]})]})]}),(0,k.jsxs)(`section`,{className:`hero-card hero-setup`,children:[(0,k.jsx)(`h2`,{children:`Setup in 3 steps`}),(0,k.jsxs)(`div`,{className:`step`,children:[(0,k.jsx)(`span`,{children:`1`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`Install the wrapper`}),(0,k.jsx)(`pre`,{className:`code-block compact`,children:qe})]})]}),(0,k.jsxs)(`div`,{className:`step`,children:[(0,k.jsx)(`span`,{children:`2`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`Render a component or wrap a surface`}),(0,k.jsx)(`pre`,{className:`code-block compact`,children:`<Loading visible options={{ variant: 'orbit' }} />`})]})]}),(0,k.jsxs)(`div`,{className:`step`,children:[(0,k.jsx)(`span`,{children:`3`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`Use a hook for fullscreen workflows`}),(0,k.jsx)(`pre`,{className:`code-block compact`,children:`const loading = useLoadingController();`})]})]})]})]}),(0,k.jsx)(`div`,{className:`playground-row`,children:(0,k.jsx)(Ke,{})}),(0,k.jsxs)(`main`,{className:`content-grid`,id:`examples`,children:[(0,k.jsxs)(`section`,{className:`examples-column`,children:[(0,k.jsx)(Qe,{title:`Basic component`,description:`Use the React component when the loading element itself is the thing being rendered in the tree.`,code:Je,children:(0,k.jsx)(`div`,{className:`surface-frame`,children:(0,k.jsx)(Ae,{visible:!0,options:{variant:`orbit`,size:56,centered:!0,color:`#2563eb`,secondaryColor:`#bfdbfe`,label:`Loading dashboard`},className:`component-stage`,style:{minHeight:220}})})}),(0,k.jsxs)(Qe,{title:`Dashboard card overlay`,description:`Wrap an existing card surface and let the loader overlay the active region while the rest of the UI stays stable.`,code:Ye,children:[(0,k.jsx)(`div`,{className:`inline-actions`,children:(0,k.jsx)(`button`,{type:`button`,className:`button secondary`,onClick:u,children:`Replay card loader`})}),(0,k.jsxs)(Me,{visible:i,options:{overlay:!0,centered:!0,variant:`glass-spinner`,color:`#2563eb`,secondaryColor:`#dbeafe`,label:`Loading revenue card`,minVisible:400},className:`card-shell`,children:[(0,k.jsx)(`div`,{className:`card-metric`,children:`$128,400`}),(0,k.jsx)(`div`,{className:`card-caption`,children:`Quarterly expansion pipeline`}),(0,k.jsxs)(`div`,{className:`card-bars`,children:[(0,k.jsx)(`span`,{style:{height:`46%`}}),(0,k.jsx)(`span`,{style:{height:`68%`}}),(0,k.jsx)(`span`,{style:{height:`54%`}}),(0,k.jsx)(`span`,{style:{height:`79%`}})]})]})]}),(0,k.jsx)(Qe,{title:`Button and submit states`,description:`Use the same overlay wrapper around a button group when a request should stay anchored to the action that triggered it.`,children:(0,k.jsx)(`div`,{className:`button-surface`,children:(0,k.jsx)(Me,{visible:o,options:{overlay:!0,centered:!0,variant:`liquid-pill`,size:42,label:``},className:`button-shell`,children:(0,k.jsx)(`button`,{type:`button`,className:`cta-button`,onClick:d,children:`Sync invoice`})})})}),(0,k.jsx)(Qe,{title:`Fullscreen and programmatic hook`,description:`Use the hook when the loading state is tied to navigation, bootstrapping, or a larger workspace transition.`,code:Xe,children:(0,k.jsx)(`div`,{className:`inline-actions`,children:(0,k.jsx)(`button`,{type:`button`,className:`button primary`,onClick:l,children:`Show fullscreen loader`})})})]}),(0,k.jsxs)(`aside`,{className:`sidebar-column`,children:[(0,k.jsxs)(`section`,{className:`demo-card side-card`,children:[(0,k.jsx)(`div`,{className:`demo-head`,children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{children:`Wrapper surface`}),(0,k.jsx)(`p`,{children:`The public API stays intentionally small so the real behavior continues to live in the core loading package.`})]})}),(0,k.jsxs)(`ul`,{className:`feature-list`,children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`code`,{children:`<Loading />`}),` for component-first loading states.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`code`,{children:`<LoadingOverlay />`}),` for cards, tables, modals, charts, and buttons.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`code`,{children:`useLoadingController()`}),` for fullscreen and programmatic flows.`]}),(0,k.jsxs)(`li`,{children:[`Core exports like `,(0,k.jsx)(`code`,{children:`loaderVariants`}),`, `,(0,k.jsx)(`code`,{children:`createLoader`}),`, and theme helpers stay available.`]})]})]}),(0,k.jsxs)(`section`,{className:`demo-card side-card`,children:[(0,k.jsx)(`div`,{className:`demo-head`,children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{children:`Release lines`}),(0,k.jsx)(`p`,{children:`Each maintained runtime line gets its own docs build and npm release.`})]})}),(0,k.jsxs)(`div`,{className:`release-links`,children:[(0,k.jsx)(`a`,{href:`../react-17/`,children:`React 17`}),(0,k.jsx)(`a`,{href:`../react-18/`,children:`React 18`}),(0,k.jsx)(`a`,{href:`../react-19/`,children:`React 19`})]})]}),(0,k.jsxs)(`section`,{className:`demo-card side-card`,children:[(0,k.jsx)(`div`,{className:`demo-head`,children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{children:`Event log`}),(0,k.jsx)(`p`,{children:`Small runtime notes from the docs interactions while you test the wrapper.`})]})}),(0,k.jsx)(`div`,{className:`event-log`,children:n.map(e=>(0,k.jsx)(`div`,{className:`log-line`,children:e},e))})]})]})]})]})}var et=document.getElementById(`root`);if(!et)throw Error(`Root element not found.`);(0,Fe.createRoot)(et).render((0,k.jsx)(O.StrictMode,{children:(0,k.jsx)($e,{reactLine:`19.2.4`})}));