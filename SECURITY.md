...
[GitHub Security Advisories](https://github.com/alexandroit/react-loading/security/advisories/new).
Do not publish exploit details in a GitHub issue.

Include the affected version, React and Node.js versions, a minimal synthetic
